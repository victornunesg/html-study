...
poder fazer a cobrança dos clientes. Queremos então criar uma lista com os clientes inadimplentes (apenas o CPF e o
valor que eles estão devendo).
...
#     if dias > 20:
#         inadimplentes.append((cpf, valor))
# print(inadimplentes)
# print(len(inadimplentes))
#
# inadimplentes2 = [(cpf, valor) for cpf, valor, dias in clientes_devedores if dias > 20]
# print(inadimplentes2)
# print(len(inadimplentes2))
#
# print(len(clientes_devedores))

""" TAMANHO DO PEDIDO DE COMPRAS
Nesse exercício vamos avaliar o estoque de uma empresa.
Vamos considerar que todos os produtos dessa empresa são comprados em lotes de 500 unidades.
...
#     if qtde < 200:
#         lista_pedidos.append((produto, 1000))
#     else:
#         lista_pedidos.append((produto, 500))
# print(lista_pedidos)
#
# pedidos = [(produto, 1000) if qtde < 200 else (produto, 500) for produto, qtde in estoque]
# print(pedidos)
...
for i, produto in enumerate(produtos):
    if produto in top5:
        vendas_top5 += vendas[i]
print(f'Top 5 representou {vendas_top5/sum(vendas):.1%} das vendas.')

# fazendo por LIST COMPREHENSION
# neste caso, não estamos produzindo uma lista, e sim uma SOMA de valores:
total_top5 = sum(vendas[i] for i, produto in enumerate(produtos) if produto in top5)
print(f'Top 5 representou {total_top5/sum(vendas):.1%} das vendas.')
